...
class DefenderRight(SoccerRobot):
    ...
    def decideMotion(self, ballCoordinate, selfCoordinate):
        ...
        if RedTeamStrategies.getZone(ballCoordinate) > 9:
            ...
            if self.getBallOwner()[0] == "R" and self.getBallOwner() != "RED_DEF_R":
                ...
                if RedTeamStrategies.getZone(selfCoordinate) != 15:
                    ...
                    turningAngle = Functions.calculateTurningAngleAccordingToRobotHeading([zoneTargetX, zoneTargetY],
                                                                                          selfCoordinate,
                                                                                          robotHeadingAngle)
                ...
                # Head to ball.
                    ...
                    turningAngle = Functions.calculateTurningAngleAccordingToRobotHeading(ballCoordinate,
                                                                                          selfCoordinate,
                                                                                          robotHeadingAngle)
                    turningMotion = self.getTurningMotion(turningAngle)
                    if turningMotion is not None:
            ...
            # The ball on the robot itself
                ...
                if bodyDistanceFromBall < 0.25:
                    ...
                    if RedTeamStrategies.getZone(ballCoordinate) == 16 or RedTeamStrategies.getZone(
                            ballCoordinate) == 18:
                        turningAngleForGoalLeft = Functions.calculateTurningAngleAccordingToRobotHeading(
                            [RedTeamStrategies.PLAY_ZONE[17][0][0], 0], selfCoordinate, robotHeadingAngle)
                        turningAngleForGoalRight = Functions.calculateTurningAngleAccordingToRobotHeading(
                            [RedTeamStrategies.PLAY_ZONE[17][1][0], 0], selfCoordinate, robotHeadingAngle)
                    ...
                    # Else, shoot to goal!
                        ...
                        turningAngleForGoalLeft = Functions.calculateTurningAngleAccordingToRobotHeading(
                            RedTeamStrategies.BLUE_GOAL["Left"], selfCoordinate, robotHeadingAngle)
                        turningAngleForGoalRight = Functions.calculateTurningAngleAccordingToRobotHeading(
                            RedTeamStrategies.BLUE_GOAL["Right"], selfCoordinate, robotHeadingAngle)
        ...
        # The ball on right or middle zone field.
        elif RedTeamStrategies.getZone(ballCoordinate) == 3 or RedTeamStrategies.getZone(
                ballCoordinate) == 6 or RedTeamStrategies.getZone(ballCoordinate) == 9 or \
                RedTeamStrategies.getZone(ballCoordinate) == 2 or RedTeamStrategies.getZone(
            ballCoordinate) == 5 or RedTeamStrategies.getZone(ballCoordinate) == 8:
            ...
            # The ball on the opponent or on the robot itself.
                ...
                if bodyDistanceFromBall < 0.25:
                    ...
                    turningAngleForGoalLeft = Functions.calculateTurningAngleAccordingToRobotHeading(
                        [RedTeamStrategies.PLAY_ZONE[11][0][1], RedTeamStrategies.PLAY_ZONE[11][1][0]], selfCoordinate,
                        robotHeadingAngle)
                    turningAngleForGoalRight = Functions.calculateTurningAngleAccordingToRobotHeading(
                        [RedTeamStrategies.PLAY_ZONE[11][0][0], RedTeamStrategies.PLAY_ZONE[11][1][1]], selfCoordinate,
                        robotHeadingAngle)

...
class SupervisorBase(Supervisor):
    ...
    def getballOwner(self):
        ...
        minDistance = BasicFunction.calculateDistance(ballPosition, self.getrobotPosition("Red_Goalkeeper"))
        for i, key in enumerate(self.robots):
            ...
            if tempDistance < minDistance:
                ...
                #         ballOwnerRobotName = ballOwnerRobotName + "a"
    ...
    def sendsupervisorData(self):
        ...
        data = struct.pack('dd9ss24d', ballPosition[0], ballPosition[1], ballOwner, ballpriority, Red_Goalkeeper[0],
                           Red_Goalkeeper[1], Red_Goalkeeper[2], Red_Defender_1[0], Red_Defender_1[1], Red_Defender_1[2], Red_Defender_2[0], Red_Defender_2[1],
                           Red_Defender_2[2], Red_Striker_1[0], Red_Striker_1[1], Red_Striker_1[2], Blue_Goalkeeper[0], Blue_Goalkeeper[1],
                           Blue_Goalkeeper[2], Blue_Striker_1[0], Blue_Striker_1[1], Blue_Striker_1[2],
                           Blue_Defender_1[0], Blue_Defender_1[1], Blue_Defender_1[2], Blue_Defender_2[0],
                           Blue_Defender_2[1], Blue_Defender_2[2])

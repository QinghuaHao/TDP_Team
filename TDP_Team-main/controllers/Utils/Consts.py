...
INITIAL_TRANSLATIONS = {
  ...
  "RED_GK"    : [-4.50,  0.00, 0.35],
  "RED_DEF_L" : [-2.00,  2.00, 0.35],
  "RED_DEF_R" : [-2.00, -2.00, 0.35],
  "RED_FW"    : [-1.00,  0.00, 0.35],

  "BLUE_GK"   : [ 4.00,  0.00, 0.35],
  "BLUE_DEF"  : [ 3.00,  0.00, 0.35],
  "BLUE_FW_L"  : [ 1.40, -1.20, 0.35],
  "BLUE_FW_R"  : [ 1.40,  1.20, 0.35]
}
